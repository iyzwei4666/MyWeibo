...
public class MainActivity extends BaseActivity {
    ...
    public void initData(@Nullable Bundle savedInstanceState) {
        ...
        douban=(Button)findViewById(R.id.douban);

        saleButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Utils.navigation(MainActivity.this, RouterHub.SALEACTIVITY);
            }
        });
        searchButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Utils.navigation(MainActivity.this, RouterHub.SEARCH_ACTIVITY);
            }
        });
        douban.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Utils.navigation(MainActivity.this, RouterHub.DOUBAN_SEARCH);
            }
        });
    }
